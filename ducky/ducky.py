...
adster_dir = os.path.normpath(os.path.join(dir_path, '..'))
...
def ducky() -> None:
    ...
    parser.add_argument("--directory", "-d", help="The directory to be processed", default=adster_dir)
    ...
    #shown that the codellama:7b-python is good for returning python code from the program.
